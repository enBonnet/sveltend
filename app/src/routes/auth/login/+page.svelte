...
<div class="mx-auto max-w-xl text-center">
	<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
		<div class="w-full max-w-md space-y-3 rounded-xl p-8 dark:bg-gray-900 dark:text-gray-100">
			...
			<form use:enhance method="POST" class="space-y-6">
				<div class="space-y-1 text-sm">
					...
					<input
						...
						class="w-full rounded-md px-4 py-3 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400"
					/>
				</div>
				<div class="space-y-1 text-sm">
				...
				<button
					class="block w-full rounded-sm p-3 text-center dark:bg-violet-400 dark:text-gray-900"
					>Sign in</button
				>
			</form>
			<div class="flex items-center space-x-1 pt-4">
				<div class="h-px flex-1 dark:bg-gray-700 sm:w-16" />
				<p class="px-3 text-sm dark:text-gray-400">Login with social accounts</p>
				<div class="h-px flex-1 dark:bg-gray-700 sm:w-16" />
			</div>
			<div class="flex justify-center space-x-4">
				<button aria-label="Log in with Google" class="rounded-sm p-3">
				...
				<button aria-label="Log in with Twitter" class="rounded-sm p-3">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="h-5 w-5 fill-current">
						<path
				...
				<button aria-label="Log in with GitHub" class="rounded-sm p-3">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="h-5 w-5 fill-current">
						<path
			...
			<p class="text-center text-xs dark:text-gray-400 sm:px-6">
				Don't have an account?
				<a rel="noopener noreferrer" href="/signup" class="underline dark:text-gray-100">Sign up</a>
			</p>
		</div>
	</div>
</div>
